...
5. Record `Pass`/`Fail`/`Blocked`/`Not Run`/`Inconclusive`, evidence, mutation, cleanup, leftovers, and redaction. Only clear expected result plus met precondition may `Fail`.
