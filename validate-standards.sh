...
templates=(manifest.yaml status.md requirements.md exploration.md test-cases.md automation.md report.md defect.md open-question.md README.md)
...
for name in status.md requirements.md exploration.md test-cases.md automation.md report.md defect.md open-question.md; do
